...
```
The leading 2 words are refresh with coefficient of 3.93 and gem with coefficient of 2.78. There are the two words that are most likely positively related to the probability of being a good review.
...
glm ROC is 0.8238, smaller than lasso ROC 0.9253
...
#MCE is .156 which is closed to OOB error of .0.166
