...
pacman::p_load(tidyverse, skimr, RCurl, 
              ...
              randomForest,  rattle, pROC,usmap,xtable,ggcorrplot,fastDummies,caret,janitor) 
```
...
# load a subset of the data since github can only store smaller files
data_full_clean <- fread("data_final_sub.csv")
...
# n1 <- 100000
# n2 <- 35000
# To test if the code works, please run below rather than above
n1 <- 1000
n2 <- 350
