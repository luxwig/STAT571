...
```{r}
m1 <- lm(mpg ~ cylinders + displacement + horsepower + weight, data = auto)
summary(m1)
#fit with higher order tersm
m2 <- lm(mpg ~ cylinders + displacement + horsepower + weight + as.factor(origin), data = auto)
summary(m2)
m3 <- lm(mpg ~ cylinders + displacement + horsepower + weight + as.factor(origin)+ horsepower : as.factor(origin), data = auto)
summary(m3)
