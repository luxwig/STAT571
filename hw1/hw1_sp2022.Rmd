...
sum(radio$wharton == "Yes")/sum(radio$sirius == "Yes") * 51.6
#2.48 million
radio$wharton <- as.factor(radio$wharton)
summary(glm(wharton ~ income + age + education + age, data = radio,family = "binomial"))
#calculate four categories with possibilities
P_XM <- sum(radio$gender == "Male" & radio$wharton == "Yes")/nrow(radio)
P_M <- 0.43 # percentage of male participants on MTurk 
P_XNM <- sum(radio$gender == "Female" & radio$wharton == "Yes")/nrow(radio)
