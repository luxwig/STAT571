...
We can use the method described in the previous section to estimate the audience size. Another proposed method of estimating audience size is to use the simple logic of ratios to approximate the number of Wharton listeners. Prop of Sirius listeners in sample/Prop of Wharton listeners in sample = Number of Sirius listeners in population/Number of Wharton listeners in population. 

We are proposing collecting a demographically representative random sample from the general population using a company called Forthright, which is a survey collection company that runs high quality surveys on sample populations.
