...
From above analysis, we purposed one model:
...
We choose the model without any binning as our final models. using the valiadtion data set, the true ROC curve is as following:
...
We put great emphasize on the first diagnosis as we think it is very helpful and easy to be use in clinical settings - different specicalities in the wards shall use these receommdantions to predict their paitent outcome and readmitted rate
